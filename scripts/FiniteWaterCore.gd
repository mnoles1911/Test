...
# introduced, in voxels (30 vox = 3 m at 10 vox/m — the designer's
# locked 3-metre reach; was 18 at the old 6 vox/m scale). Each
# sideways step into fresh air increments a cell's "distance
# budget"; at 30 the front
