...
- **Voxel block size**: **10 voxels per meter (10 cm per voxel)** — updated 2026-06-12 from the old 6 vox/m (16.7 cm). NOT 1-metre Minecraft cubes; fine enough for stone texture, cobblestone, timber planks. (Engine constant migration tracked in `../DESIGNER_TODO.md` §8; some derived voxel counts in this doc and `ART_PIPELINE.md` — character/building dims — still reference the old 6 vox/m scale and need a consistency pass.)
