...
- **Future polish:** caustics on the submerged lakebed (PR Phase 4-b in `design/WATER_SHADER_V3_PLAN.md`); per-biome fog/extinction overrides (read water-body biome at player position).
