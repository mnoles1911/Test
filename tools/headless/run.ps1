...
param(
	...
	[ValidateSet("gate0", "codec", "wmat", "shader", "phase7", "spike", "phase2", "gen", "distant", "gravity", "emissive", "baked_light", "water_flow", "finite", "finite_world", "sever", "entity", "scale", "flora", "biome", "mining")]
	[string]$Selector,
