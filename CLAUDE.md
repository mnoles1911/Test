...
Outstanding pickups: Blender Roland model, MagicaVoxel prop exports, surface decoration pass, ambient weather audio, region-boundary profile auto-swap, LOD1+ water surface line artefact (shader fix), in-engine smoke + PR for `perf/vgm-elm-cpp-ports`. See `DESIGNER_TODO.md`.
