...
The vertical split between lower and upper city is the defining scale feature. The sea-lift is a scene-to-scene transition mechanism (the one mechanical exception to foot travel in Act II).

---

## Art Direction Notes

Strong visual split between two registers:
- **Lower city:** wet, dark wood, salt air, rope. Ship-timber construction. Ground floors are stone storage; living quarters are wood above. Flood-adapted. Orion Farr is found here.
- **Upper city:** stone, windswept, fleet-command austere. The Tidewarden administrative buildings are as close to military as civilian architecture gets.

The sea-lifts — iron cage counterweight systems — are a distinctive piece of dwarven engineering in a human city. They have been maintained for 200 years; they look it. Functional, maintained, slightly ominous.

Lighthouse at the headland tip: a reference point visible from sea and from the lower city below.
...
- Exact dimensions of Eilwen's court not defined
- Sea-lift as a playable mechanic vs. a transition cutscene — not decided
- The voyage is noted as "a moving environment" — ship deck scene geometry needs its own design pass
- Copper Isles Archive is a separate location from Caer Brannoch; needs its own stub file (not listed in current scope — flag as future work)
- Storm sequence on the voyage: weather mechanics not designed
