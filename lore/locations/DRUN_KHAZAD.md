...
- [x] Caldera width: GAP — shield volcano calderas vary; suggest ~300–800 m across = 2400–6400 voxels (not all traversable; the playable caldera rim and Hollow Hearth are a fraction of this)
- [x] Hollow Hearth chamber: natural chamber in caldera inner wall — ~30 m wide × 20 m deep × 15 m tall = 240 × 160 × 120 voxels (estimate; final boss arena scale)
...
- [x] Camera arm length: upper slopes = arm 14–16, elevation 42° (open, exposed, wide view); Hollow Hearth = arm 10–12, elevation 50°; caldera floor = GAP
...
2. **Hollow Hearth and caldera:** enclosed, deep orange-red from the caldera glow, the Aescstól at the center. Where the slope was vast and exposed, this is tight and hot.
...
The final confrontation at Drûn-Khazad is the climax of Game One. Scene structure:
1. Western slope ascent (the approach, post-Binding Site)
2. Upper slope combat (the battle; faction commitments determine who fights alongside Roland)
3. Hollow Hearth (the final confrontation with Mordvar)

---

## Connections

- **Arrives from:** Act IV Binding Site (via the Ashfields approach, then the Thal crossing, then the Ash-Steppe)
- **Exits to:** Game One ending (both endings — The Exchange and The Tether — resolve at or from this location)

---

## Open Questions / Gaps

- Binding Site is at Drûn-Khazad or at the Ashfields? The lore mentions "Binding Site ritual" in the Ashfields approach (Act IV) — is the ritual there or at the volcano? Needs clarification.
...
- The Hollow Hearth fight with Mordvar: the final boss encounter design is not yet written
- Both endings (The Exchange / The Tether) — see GAME1_PART2.md; spatial implications for the ending cinematics not yet mapped to geometry
- Caldera access: does the player descend into the caldera or approach the Hollow Hearth from the rim level?
