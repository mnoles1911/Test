...
## Overview
Game 1's side quests serve two purposes: they build out the world's texture and they plant seeds that pay off in Games 2 and 3. None are mandatory. All are available to a player who explores.

---

## 1. The Ashsteel Formula (Introduction)

**Questgiver:** A weapons trader named Orvin in the first major settlement, nursing a broken leg and a grievance.

**Summary:** Orvin was transporting a commission — a sample of ashsteel, a dwarven alloy formula that has been lost for two generations — when his cart was ambushed by Ashen Hand agents who took the sample and left him for dead. He believes they were after the formula itself, not the physical object.

**What the player does:** Tracks the agents to a waystation, recovers Orvin's documentation, and discovers the formula isn't complete — it references a materials source in Khorumzad that Orvin has never been able to identify.

**Payoff:** The ashsteel formula thread continues in Games 2 and 3. In Game 2, Barak Stonecroft has the missing materials reference. In Game 3, fully manufactured ashsteel has a property that matters for the final confrontation.

**Tone:** Grounded. A small theft with large implications the player won't understand until much later.
...
## 3. Brightwatch Border Incident

**Questgiver:** A retired Iron Chalice soldier named Hett, living near the old Brightwatch approach road.

**Summary:** Three weeks ago, a small group of travellers was turned back from the Brightwatch area by people claiming to be Chalice representatives. Hett knows the Chalice's patrol schedules and the described people don't match any active roster. He wants to know who they were and what they were looking for.

**What the player does:** Investigates the incident site and discovers evidence of a surveying operation — someone was mapping the ground in the Brightwatch vicinity, specifically the approaches to the chapel Roland found. The surveyors were Ashen Hand.

**Payoff:** Confirms the Ashen Hand knows the chapel exists. Creates urgency in the main plot. Roland recognizes the survey methodology from his Iron Chalice training.

**Tone:** Quietly alarming. The enemy is closer and more informed than the party hoped.
...
## 6. The Ledger's Price

**Questgiver:** A nervous archivist in the regional administrative center named Poul.

**Summary:** Poul has discovered a discrepancy in the kingdom's land survey records — a parcel near the Ashfields has been administratively reassigned three times in the last decade under different names, all of which turn out to be fictional. Someone is holding land invisibly. He's afraid to report it through official channels because he doesn't know who is watching.
...
**Questgiver:** Darva, an inn owner in a border town who has a problem she cannot solve and won't explain until she trusts the party.

**Summary:** The Pale Supper has been using Darva's inn as a meeting location for a year, paying well and threatening implicitly. She wants them out but does not want to be seen as the one who moved against them. She has a daughter in the city who doesn't know any of this.
